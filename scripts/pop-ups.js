...
//popup login
			...
			function centerPopuplog(){
				var windowWidth = document.documentElement.clientWidth;
				var windowHeight = document.documentElement.clientHeight;
				var popuplogHeight = $("#popuplog").height();
				var popuplogWidth = $("#popuplog").width();
				$("#popuplog").css({
					"position": "absolute",
					"top": windowHeight/2-popuplogHeight/2,
					"left": windowWidth/2-popuplogWidth/2
				});
			}
			...
			$(document).ready(function(){
				...
				$("#popuplog").css({
					...
					centerPopuplog();
					loadPopuplog();
				    $("#popuplog").mCustomScrollbar("vertical",400,"easeOutCirc",1.05,"auto","yes","yes",10);						
				});
				$("#popuplogClose").click(function(){
					disablePopuplog();
				});
				$("#bg").click(function(){
					disablePopuplog();
